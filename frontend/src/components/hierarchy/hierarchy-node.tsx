...
import { ConfidenceBar } from '@/components/hierarchy/confidence-bar'
import { NodeMetadata } from '@/components/hierarchy/node-metadata'
...
const tagColorMap: Record<string, string> = {
  Completed: 'border-chart-2/40 text-chart-2 bg-chart-2/10',
  Active: 'border-primary/40 text-primary bg-primary/10',
  Locked: 'border-muted-foreground/40 text-muted-foreground bg-muted',
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                {/* Edit button for topic nodes */}
                {onEdit && node.type === 'topic' && (
                  <div
                    ...
                    tabIndex={0}
                  >
                    <div className="flex items-center gap-1 rounded-md border border-border bg-secondary px-2 py-0.5 text-[10px] text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors">
